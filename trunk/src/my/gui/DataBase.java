...
public class DataBase {
	...
	//Funcion que devuelve los distintos valores de la columna decision
	public static ArrayList getValoresColDecision() throws SQLException{
		Statement stmt = null;
        ResultSet rs = null;
		...
		while (rs.next()) {
            lista.add(rs.getString(columna_decision));
        }
		return lista;
	}
